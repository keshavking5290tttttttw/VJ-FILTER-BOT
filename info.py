...
API_ID = int(environ.get('API_ID', '26611191'))
API_HASH = environ.get('API_HASH', 'e896ad7f99e7a348040089519c5dc820')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002181819977'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6276979693 7131600952').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002173577751').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://keshg97557:<keshav@0110>@cluster0.v4wkuex.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "techvjautobot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'techvjcollection')

# Premium And Referal Settings
PREMIUM_AND_REFERAL_MODE = bool(environ.get('PREMIUM_AND_REFERAL_MODE', fol)) # Set Ture Or False
